""" 
This script runs all OMIO readers on dummy data files generated by the other 
scripts in this folder, to ensure that they can read the files without errors.

author: Fabrizio Musacchio
date: December 2025
"""
# %% IMPORTS
# this file lays in project/some_folder and we import from project/omio; 
# therefore, we need to add the parent folder of project/omio to sys.path:
import re
import sys, os
